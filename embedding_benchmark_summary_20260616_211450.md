...
**Fecha:** 2026-06-16 21:14  
**Modelos evaluados:** multilingual-e5-small · minilm-code-search-512 · all-minilm-l6-v2  
**Casos evaluados:** 16  
...
|--------|-------|-----|-----|-----|---------|--------|-------|
| *  `minilm-code-search-512` | 93.8% | 0.953 | 0.562 | 0.791 | +0.1553 | 9.6ms | **0.8356** |
| `all-minilm-l6-v2` | 87.5% | 0.896 | 0.542 | 0.728 | +0.1949 | 10.7ms | **0.8088** |
| `multilingual-e5-small` | 87.5% | 0.927 | 0.604 | 0.869 | +0.0380 | 47.8ms | **0.7647** |
...
|--------|-------|-----|-----|-----|-----------|-----------|-----|--------|
| `multilingual-e5-small` | ✓ | 1.000 | 1.000 | 0.200 | 0.8829 | 0.8333 | +0.0496 | 75.4ms |
| `minilm-code-search-512` | ✓ | 1.000 | 1.000 | 0.200 | 0.5674 | 0.4894 | +0.0780 | 23.7ms |
| `all-minilm-l6-v2` | ✓ | 1.000 | 1.000 | 0.200 | 0.6252 | 0.3033 | +0.3218 | 23.3ms |
...
| Modelo | Hit@1 | MRR | P@3 | R@3 | MaxSimRel | MaxSimIrr | Gap | ms/enc |
|--------|-------|-----|-----|-----|-----------|-----------|-----|--------|
| `multilingual-e5-small` | ✓ | 1.000 | 1.000 | 0.750 | 0.8788 | 0.8326 | +0.0462 | 62.0ms |
| `minilm-code-search-512` | ✓ | 1.000 | 0.667 | 0.500 | 0.4383 | 0.3634 | +0.0749 | 9.2ms |
| `all-minilm-l6-v2` | ✓ | 1.000 | 0.667 | 0.500 | 0.5390 | 0.3940 | +0.1450 | 10.0ms |
...
| Modelo | Hit@1 | MRR | P@3 | R@3 | MaxSimRel | MaxSimIrr | Gap | ms/enc |
|--------|-------|-----|-----|-----|-----------|-----------|-----|--------|
| `multilingual-e5-small` | ✓ | 1.000 | 0.667 | 1.000 | 0.8971 | 0.8386 | +0.0585 | 66.2ms |
| `minilm-code-search-512` | ✓ | 1.000 | 0.667 | 1.000 | 0.5275 | 0.4538 | +0.0737 | 9.1ms |
| `all-minilm-l6-v2` | ✓ | 1.000 | 0.667 | 1.000 | 0.5284 | 0.3737 | +0.1547 | 9.4ms |
...
| Modelo | Hit@1 | MRR | P@3 | R@3 | MaxSimRel | MaxSimIrr | Gap | ms/enc |
|--------|-------|-----|-----|-----|-----------|-----------|-----|--------|
| `multilingual-e5-small` | ✓ | 1.000 | 0.667 | 1.000 | 0.9031 | 0.8884 | +0.0146 | 55.6ms |
| `minilm-code-search-512` | ✓ | 1.000 | 0.667 | 1.000 | 0.7333 | 0.6319 | +0.1015 | 7.4ms |
| `all-minilm-l6-v2` | ✓ | 1.000 | 0.667 | 1.000 | 0.7495 | 0.6018 | +0.1477 | 8.4ms |
...
| Modelo | Hit@1 | MRR | P@3 | R@3 | MaxSimRel | MaxSimIrr | Gap | ms/enc |
|--------|-------|-----|-----|-----|-----------|-----------|-----|--------|
| `multilingual-e5-small` | ✓ | 1.000 | 1.000 | 0.750 | 0.8878 | 0.8538 | +0.0340 | 47.4ms |
| `minilm-code-search-512` | ✓ | 1.000 | 1.000 | 0.750 | 0.5911 | 0.2640 | +0.3271 | 7.2ms |
| `all-minilm-l6-v2` | ✓ | 1.000 | 1.000 | 0.750 | 0.6756 | 0.2004 | +0.4751 | 7.5ms |
...
| Modelo | Hit@1 | MRR | P@3 | R@3 | MaxSimRel | MaxSimIrr | Gap | ms/enc |
|--------|-------|-----|-----|-----|-----------|-----------|-----|--------|
| `multilingual-e5-small` | ✓ | 1.000 | 0.333 | 1.000 | 0.9119 | 0.8429 | +0.0690 | 62.0ms |
| `minilm-code-search-512` | ✓ | 1.000 | 0.333 | 1.000 | 0.5579 | 0.3208 | +0.2371 | 9.9ms |
| `all-minilm-l6-v2` | ✓ | 1.000 | 0.333 | 1.000 | 0.7046 | 0.4443 | +0.2603 | 9.8ms |
...
| Modelo | Hit@1 | MRR | P@3 | R@3 | MaxSimRel | MaxSimIrr | Gap | ms/enc |
|--------|-------|-----|-----|-----|-----------|-----------|-----|--------|
| `multilingual-e5-small` | ✓ | 1.000 | 0.667 | 1.000 | 0.9044 | 0.8321 | +0.0724 | 68.5ms |
| `minilm-code-search-512` | ✓ | 1.000 | 0.667 | 1.000 | 0.4076 | 0.2071 | +0.2004 | 9.2ms |
| `all-minilm-l6-v2` | ✓ | 1.000 | 0.667 | 1.000 | 0.4796 | 0.2493 | +0.2302 | 10.0ms |
...
| Modelo | Hit@1 | MRR | P@3 | R@3 | MaxSimRel | MaxSimIrr | Gap | ms/enc |
|--------|-------|-----|-----|-----|-----------|-----------|-----|--------|
| `multilingual-e5-small` | ✓ | 1.000 | 0.667 | 1.000 | 0.9250 | 0.8535 | +0.0715 | 77.1ms |
| `minilm-code-search-512` | ✓ | 1.000 | 0.667 | 1.000 | 0.6481 | 0.3406 | +0.3075 | 9.6ms |
| `all-minilm-l6-v2` | ✓ | 1.000 | 0.667 | 1.000 | 0.6539 | 0.3351 | +0.3188 | 11.0ms |
...
| Modelo | Hit@1 | MRR | P@3 | R@3 | MaxSimRel | MaxSimIrr | Gap | ms/enc |
|--------|-------|-----|-----|-----|-----------|-----------|-----|--------|
| `multilingual-e5-small` | ✓ | 1.000 | 0.333 | 1.000 | 0.8989 | 0.8515 | +0.0474 | 62.4ms |
| `minilm-code-search-512` | ✓ | 1.000 | 0.333 | 1.000 | 0.5810 | 0.2000 | +0.3810 | 8.0ms |
| `all-minilm-l6-v2` | ✓ | 1.000 | 0.333 | 1.000 | 0.6601 | 0.2478 | +0.4123 | 9.7ms |
...
| Modelo | Hit@1 | MRR | P@3 | R@3 | MaxSimRel | MaxSimIrr | Gap | ms/enc |
|--------|-------|-----|-----|-----|-----------|-----------|-----|--------|
| `multilingual-e5-small` | ✓ | 1.000 | 0.333 | 1.000 | 0.8782 | 0.8527 | +0.0255 | 53.7ms |
| `minilm-code-search-512` | ✓ | 1.000 | 0.333 | 1.000 | 0.6070 | 0.3899 | +0.2171 | 7.7ms |
| `all-minilm-l6-v2` | ✓ | 1.000 | 0.333 | 1.000 | 0.6186 | 0.3532 | +0.2654 | 8.8ms |
...
| Modelo | Hit@1 | MRR | P@3 | R@3 | MaxSimRel | MaxSimIrr | Gap | ms/enc |
|--------|-------|-----|-----|-----|-----------|-----------|-----|--------|
| `multilingual-e5-small` | ✗ | 0.333 | 0.333 | 1.000 | 0.8522 | 0.8557 | -0.0035 | 36.0ms |
| `minilm-code-search-512` | ✓ | 1.000 | 0.333 | 1.000 | 0.3228 | 0.2750 | +0.0479 | 9.1ms |
| `all-minilm-l6-v2` | ✗ | 0.167 | 0.000 | 0.000 | 0.2461 | 0.4403 | -0.1942 | 11.1ms |
...
| Modelo | Hit@1 | MRR | P@3 | R@3 | MaxSimRel | MaxSimIrr | Gap | ms/enc |
|--------|-------|-----|-----|-----|-----------|-----------|-----|--------|
| `multilingual-e5-small` | ✓ | 1.000 | 0.333 | 1.000 | 0.8639 | 0.8401 | +0.0238 | 22.2ms |
| `minilm-code-search-512` | ✓ | 1.000 | 0.333 | 1.000 | 0.3464 | 0.3372 | +0.0092 | 9.4ms |
| `all-minilm-l6-v2` | ✗ | 0.167 | 0.000 | 0.000 | 0.1777 | 0.2749 | -0.0972 | 9.7ms |
...
| Modelo | Hit@1 | MRR | P@3 | R@3 | MaxSimRel | MaxSimIrr | Gap | ms/enc |
|--------|-------|-----|-----|-----|-----------|-----------|-----|--------|
| `multilingual-e5-small` | ✓ | 1.000 | 0.333 | 1.000 | 0.8661 | 0.8463 | +0.0198 | 19.6ms |
| `minilm-code-search-512` | ✗ | 0.250 | 0.000 | 0.000 | 0.2697 | 0.3125 | -0.0428 | 7.2ms |
| `all-minilm-l6-v2` | ✓ | 1.000 | 0.333 | 1.000 | 0.4078 | 0.2914 | +0.1164 | 10.8ms |
...
| Modelo | Hit@1 | MRR | P@3 | R@3 | MaxSimRel | MaxSimIrr | Gap | ms/enc |
|--------|-------|-----|-----|-----|-----------|-----------|-----|--------|
| `multilingual-e5-small` | ✗ | 0.500 | 0.333 | 1.000 | 0.8250 | 0.8440 | -0.0190 | 15.8ms |
| `minilm-code-search-512` | ✓ | 1.000 | 0.333 | 1.000 | 0.3039 | 0.2209 | +0.0829 | 8.3ms |
| `all-minilm-l6-v2` | ✓ | 1.000 | 0.333 | 1.000 | 0.2723 | 0.2608 | +0.0115 | 9.5ms |
...
| Modelo | Hit@1 | MRR | P@3 | R@3 | MaxSimRel | MaxSimIrr | Gap | ms/enc |
|--------|-------|-----|-----|-----|-----------|-----------|-----|--------|
| `multilingual-e5-small` | ✓ | 1.000 | 1.000 | 0.200 | 0.8541 | 0.8075 | +0.0466 | 19.2ms |
| `minilm-code-search-512` | ✓ | 1.000 | 1.000 | 0.200 | 0.5569 | 0.4977 | +0.0592 | 9.6ms |
| `all-minilm-l6-v2` | ✓ | 1.000 | 1.000 | 0.200 | 0.4686 | 0.3314 | +0.1372 | 11.5ms |
...
| Modelo | Hit@1 | MRR | P@3 | R@3 | MaxSimRel | MaxSimIrr | Gap | ms/enc |
|--------|-------|-----|-----|-----|-----------|-----------|-----|--------|
| `multilingual-e5-small` | ✓ | 1.000 | 0.667 | 1.000 | 0.8658 | 0.8142 | +0.0516 | 21.0ms |
| `minilm-code-search-512` | ✓ | 1.000 | 0.667 | 1.000 | 0.5363 | 0.2071 | +0.3292 | 9.4ms |
| `all-minilm-l6-v2` | ✓ | 1.000 | 0.667 | 1.000 | 0.4883 | 0.0758 | +0.4125 | 11.1ms |
